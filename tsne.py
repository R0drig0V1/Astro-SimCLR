...
#trials = ["checkpoint_astro2_1.ckpt", "checkpoint_astro2_2.ckpt", "checkpoint_astro2_3.ckpt", "checkpoint_astro2_4.ckpt", "checkpoint_astro2_5.ckpt"]
trials = ["checkpoint_astro8_1.ckpt", "checkpoint_astro8_2.ckpt", "checkpoint_astro8_3.ckpt", "checkpoint_astro8_4.ckpt"]#, "checkpoint_astro8_5.ckpt"]
folders = [f"/home/rvidal/weights/SimCLR_red/{trial}" for trial in trials]
...
for rep, exp_folder in enumerate(folders):
    ...
    # Plot visualization (train)
    # ---------------------------------
    file = f'figures/tsne_Train_{encoder_name}_{augmentation}-td_ztf_stamp_17_06_20-{rep+1}.png'
    simclr.plot_tSNE('Train', file, feats_in_plot=150)

    # Plot visualization (validation)
    # ---------------------------------
    file = f'figures/tsne_Validation_{encoder_name}_{augmentation}-td_ztf_stamp_17_06_20-{rep+1}.png'
    simclr.plot_tSNE('Validation', file, feats_in_plot=100)

    # Plot visualization (test)
    # ----------------------------
    file = f'figures/tsne_Test_{encoder_name}_{augmentation}-td_ztf_stamp_17_06_20-{rep+1}.png'
