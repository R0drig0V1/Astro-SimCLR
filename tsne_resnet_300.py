...
trials = ["checkpoint_astro2_1.ckpt"]#, "checkpoint_astro8_2.ckpt", "checkpoint_astro8_3.ckpt"]#, "checkpoint_astro2_4.ckpt", "checkpoint_astro2_5.ckpt"]
folders = [f"/home/rvidal/weights/SimCLR_300_resnet18_27_astro2/{trial}" for trial in trials]
...
for rep, exp_folder in enumerate(folders):
    ...
    # ---------------------------------
    file = f'figures/tsne_Validation_{encoder_name}_27_{augmentation}-td_ztf_stamp_300-{rep+1}.png'
    simclr.plot_tSNE('Validation', file, feats_in_plot=100)

    # Plot visualization (test)
    # ----------------------------
    file = f'figures/tsne_Test_{encoder_name}_27_{augmentation}-td_ztf_stamp_300-{rep+1}.png'
